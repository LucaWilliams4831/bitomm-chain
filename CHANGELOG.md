...
- (deps) [\#1098](https://github.com/evmos/evmos/pull/1098) Bump Cosmos SDK to [`v0.46.6`](https://github.com/cosmos/cosmos-sdk/releases/tag/v0.46.6)
...
- (cmd) [\#1121](https://github.com/evmos/evmos/pull/1121) Fix `bitommd version` to show either tag or last commit.
...
- (cmd) [\#543](https://github.com/evmos/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025pose`.
