...
func TestGetReceivedCoin(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/bitomm",
			"10",
			sdk.Coin{Denom: "bitomm", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped bitomm coin",
			"bitomm",
			"10",
			sdk.Coin{Denom: "bitomm", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped bitomm coin",
			"transfer/channel-0/bitomm",
			"10",
			sdk.Coin{Denom: teststypes.poseIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
