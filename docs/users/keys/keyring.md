...
MY_VALIDATOR_ADDRESS=$(bitommd keys show dev0 -a)
```
...
yes $KEYPASSWD | bitommd keys add me
yes $KEYPASSWD | bitommd keys show me
# start bitommd with keyring-backend flag
bitommd --keyring-backend=file start
```
