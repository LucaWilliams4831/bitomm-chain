...
Find below a list of  `bitommd` commands added with the  `x/revenue` module. You can obtain the full list by using the `bitommd -h` command. A CLI command can look like this:

```bash
bitommd query revenue params
```
